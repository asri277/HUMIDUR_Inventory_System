...
<!-- Update Side Nav -->
<form hidden id="mySideEditNav_supplier" class="sideManipulateNav" method="post">
  ...
  <div class="any_form_container">
    ...
    <input class="btnSubmit_anyForm" onclick="disableUpdate('iafSupplier','btnLoadOnly_supplier')" type="reset" name="reset" value="Reset" >
  </div>
